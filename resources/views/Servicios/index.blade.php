    ...
    <div class="card-body">
        <table id="motores" class="table" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $servicio->etapa->nombre }}</td>
                    <td>{{ $servicio->cliente->nombre }}</td>
                    <td>{{ $servicio->servicio }}</td>
                    <td>{{ $servicio->componente }}</td>
                    <td>{{ $servicio->modelo }}</td>
                    <td>{{ $servicio->serial }}</td>
                    <td>
                    <a href="{{ route('Servicios.show', ['id_servicio' => $servicio->id_servicio]) }}"
                    class="px-6 py-2 self-end rounded-md transition-all duration-300 ease-in-out hover:bg-[#f0a21c]/80 bg-[#F0A21C] text-white">Ver</a>
                    <a href="{{route('Bahias.asignarBahias', ['id_servicio' => $servicio->id_servicio])}}" type="button" class="px-6 py-2 rounded-md transition-all duration-300 ease-in-out hover:bg-naranja-claro-400/80 bg-naranja-claro-400 text-white">Bahías</a>
