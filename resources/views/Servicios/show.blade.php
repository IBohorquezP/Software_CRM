...
<section class="grid grid-cols-2 gap-10 justify-items-center">
    <div class="w-full col-start-2">
        ...
        <form action="{{ route('Servicios.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div id="form1" class="grid grid-cols-2 gap-5">
                <label for="servicio" class=" flex flex-col gap-2">
                    ...
                    <input type="text"
                        ...
                        class="p-2 bg-gray-100 border-4 border-black outline-0 transition-all ease-in-out duration-300 focus:border-naranja-industrial-400" disabled
                        name=servicio>
            ...
            <form action="{{ route('Servicios.destroy', $servicio->id_servicio) }}" method="POST" class="col-span-2 flex justify-evenly w-full gap-5">
                @csrf
                @method('DELETE')
