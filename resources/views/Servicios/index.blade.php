        ...
        <table id="motores" class="table" style="width:100%">
            ...
            <tbody>
                ...
                <td class="text-center">
                    ...
                    <a href="{{route('Tecnicos.showServicioTecnicos', $servicio->id_servicio)}}" type="button" class="w-20 h-10px-6 py-2 rounded-md transition-all duration-300 ease-in-out hover:bg-naranja-industrial-/80 bg-naranja-industrial-300 text-white text-center">Técnicos</a>
