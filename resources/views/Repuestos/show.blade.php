            ...
            <table id="repuestos" class="table" style="width:100%">
                ...
                <tbody>
                    @foreach ($servicio_existentes as $servicio_existente)
                        <tr>
                            <td class="text-center">{{ $servicio_existente->id_servicio_repuesto }}</td>
                            ...
                            <td class="text-center">{{ $servicio_existente->contador_cotizacion }}</td>
                            ...
                            <td class="text-center">{{ $servicio_existente->contador_colocacion }}</td>
