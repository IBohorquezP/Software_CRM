...
<div class="w-full flex justify-between items-center">
    ...
    <a href="" class="text-[45px] font-bold drop-shadow-xl ">Bahias</a>
    <a href="{{route('Bahias.asignarBahias', ['id_servicio' => $servicio->id_servicio])}}" type="button" class="w-20 h-10px-6 py-2 rounded-md transition-all duration-300 ease-in-out hover:bg-naranja-industrial-500/80 bg-naranja-industrial-400 text-white text-center">Bahías</a>
</div>
<div class="card p-4">
    <div class="card-body">
