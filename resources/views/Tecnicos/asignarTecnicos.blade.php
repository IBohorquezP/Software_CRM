    ...
    <div class="w-full">
        ...
        <form action="{{ route('Tecnicos.attachServicio') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="mt-5 flex justify-evenly w-full">
                <a href="{{ route('Tecnicos.showServicioTecnicos', $servicio->id_servicio) }}" class="font-bold py-2 px-10 rounded-sm bg-naranja-industrial-500 transition-all duration-300 ease-in-out hover:bg-amarillo-pollo-300">Volver</a>
