        ...
        <table id="motores" class="table" style="width:100%">
            ...
            <tbody>
                @foreach ($servicios as $servicio)
                    ...
                    <a href="{{route('Repuestos.create')}}" type="button" class="w-20 h-10px-6 py-2 rounded-md transition-all duration-300 ease-in-out hover:bg-gris-industrial-400/80 bg-gris-industrial-400 text-white text-center">Repuestos</a>
